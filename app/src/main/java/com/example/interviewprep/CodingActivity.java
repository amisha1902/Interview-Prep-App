...
public class CodingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expandableListView = findViewById(R.id.lvlanguages);
    ...
    private void prepareListData() {
        ...
        listDataChild.put(listDataHeader.get(0), cSubtopics);
        listDataChild.put(listDataHeader.get(1), cppSubtopics);
        listDataChild.put(listDataHeader.get(2), javaSubtopics);
        listDataChild.put(listDataHeader.get(3), pythonSubtopics);
        listDataChild.put(listDataHeader.get(4), sqlSubtopics);
    }
}
